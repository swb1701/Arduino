 ...
 *
 * This is the stock 3pi PID line follower adjusted for higher speed
 */
...
const char welcome_line1[] PROGMEM = "Emma";
...
void loop()
{
  ...
  //works on my race course -- possibly overcorrecting a little too fast (more tuning needed above) -- SWB
